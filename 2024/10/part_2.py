...
def trails(topographic_map: TopographicMap) -> Iterator[int]:
...
def main(input_path: str) -> int:
    ...
    rating: int = 0
    for trail in trails(topographic_map):
        rating += trail
    return rating
...
if __name__ == "__main__":
    ...
    map_rating: int = main(args.path[0])
    print(f"Rating of map: {map_rating}")
